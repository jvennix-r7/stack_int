...
char *test_si_mult_1_times_1() {
  CHECK_TIMES(1, 1, 1)
}

char *test_si_mult_255_times_255() {
  CHECK_TIMES(255, 255, 65025)
}

char *test_si_mult_512_times_12344() {
  CHECK_TIMES(512, 12344, 6320128)
}

char *test_si_mult_99999999_times_1() {
  CHECK_TIMES(99999999, 1, 99999999)
}


char *test_si_mult_1_times_99999999() {
  CHECK_TIMES(1, 99999999, 99999999)
}


char *test_si_mult_99999999_times_1208() {
  CHECK_TIMES(99999999, 1208, 120799998792)
}

char *test_si_mult_222_times_24() {
  CHECK_TIMES(222, 24, 5328)
}

char *test_si_mult_large1() {
  CHECK_TIMES(
...
char *all_tests() {
  ...
  mu_run_test(test_si_mult_99999999_times_1208);
  mu_run_test(test_si_mult_222_times_24);
  mu_run_test(test_si_mult_large1);
  mu_run_test(test_si_mult_large2);
  mu_run_test(test_si_mult_large3);
